document.addEventListener("DOMContentLoaded", () => {
  ...
  // Set min/max date (today → next 2 days)
  ...
  setInterval(() => setDynamicPlaceholder(dateInput), 60000); // optional update
  ...
  if (isMobile()) {
    ...
    // Only open Flatpickr when icon clicked
